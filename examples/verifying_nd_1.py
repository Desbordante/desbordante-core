...
def print_table(filename: str, row_numbers = []):
...
EXPIRED_PASSPORT_TABLE = 'examples/datasets/nd_verification_datasets/expired_passport.csv'
VALID_PASSPORTS_TABLE = 'examples/datasets/nd_verification_datasets/valid_passports_1.csv'
...
print(ENDC)
print('Let\'s run algirhtm again:')
