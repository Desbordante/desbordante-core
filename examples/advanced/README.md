...
+ [fd_and_afd_via_ga_rfd.py](https://github.com/Desbordante/desbordante-core/tree/main/examples/advanced/fd_and_afd_via_ga_rfd.py) — a scenario showing how to discover exact and approximate functional dependencies using the GA-RFD algorithm and then validate them with the AFD verifier.
...
+ [verifying_pac/verifying_domain_pac_custom_domain.py](https://github.com/Desbordante/desbordante-core/tree/main/examples/advanced/verifying_pac/verifying_domain_pac_custom_domain.py) — a scenario demonstrating how to verify a Domain PAC on a user-defined domain.
