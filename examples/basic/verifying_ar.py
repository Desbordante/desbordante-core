...
def scenario_tabular():
    ...
    algo.execute(arule_left=["Bread"], arule_right=["Butter"], minsup=supp, minconf=conf)
    ...
    print_table(table)
    algo.execute(arule_left=["Milk", "Yogurt"], arule_right=["Eggs"], minsup=supp, minconf=conf)
    print_results(algo, supp, conf)
