...
''')
    ...
    for highlight in highlights:
        ...
        print('\n')
    print('''Clearly, this type of dependency has no practical
...
def print_about_fourth_dd():
    ...
    print('''Validation of Differential Dependencies (DDs) can
...
lhs4 = [desbordante.dd_verification.create_df("student_id", 0, 0)]
rhs4 = [desbordante.dd_verification.create_df("student_name", 0, 0)]
dd4 = desbordante.dd_verification.create_dd(lhs4, rhs4)
