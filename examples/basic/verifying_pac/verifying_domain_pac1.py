...
ε={BLUE}{pac.epsilon}{ENDC} and PAC ({BLUE}{pac.epsilon}{ENDC}, {BLUE}{pac.delta}{ENDC}) holds. So, this means that ε={BLUE}{pac.epsilon}{ENDC} is the minimal ε that satisfies δ={BLUE}0.9{ENDC}.
"""
)
