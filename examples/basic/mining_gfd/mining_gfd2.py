...
PREAMBLE = (
    "Our profiler supports two tasks related to graph functional dependencies (GFDs): "
...
GFD_INFO = (
    "GFDs are functional dependencies that consist of a pattern - a graph that specifies the "
    "scope - and a rule. The nature of this object will become clearer through the "
    "example that follows.\n"
)

GRAPH_INFO = (
    "Let's analyze GFD mining through an example. Look at the graph "
...
REWRITING = (
    "It may be difficult to interpret, so let's rewrite it to a more human-readable "
...
RESULTS = "The dependency found indicates that only second-year master's students are working on the difficult task.\n"

EXAMPLE_INFO = (
    "It is recommended to look at the first example for a deeper "
