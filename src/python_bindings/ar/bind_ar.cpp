...
void BindAr(py::module_& main_module) {
    ...
    py::class_<ARStrings>(ar_module, "ARStrings")
            ...
            .def(py::pickle(
                    ...
                    [](ARStrings const& ars) {
                        ...
                        return py::make_tuple(left_vec, right_vec, ars.confidence, ars.support);
                    },
                    // __setstate__
                    [](py::tuple t) {
                        if (t.size() != 4) {
                        ...
                        return ARStrings(left_list, right_list, conf, supp);
                    }));
    ...
    py::class_<ArIDs>(ar_module, "ArIDs")
            ...
            .def(py::pickle(
                    // __getstate__
                    [](ArIDs const& arids) {
                        return py::make_tuple(arids.left, arids.right, arids.confidence, arids.support);
                    },
                    // __setstate__
                    [](py::tuple t) {
                        if (t.size() != 4) {
                        ...
                        double conf = t[2].cast<double>();
                        double supp = t[3].cast<double>();
                        return ArIDs(left, right, conf, supp);
                    }));
