...
void BindOd(py::module_& main_module) {
    ...
    py::class_<AscCanonicalOD>(od_module, "AscCanonicalOD")
            ...
            .def(py::pickle(
                    ...
                    [](AscCanonicalOD const& od) {
                        ...
                        return py::make_tuple(context_state, left, right);
                    },
                    // __setstate__
                    [](py::tuple t) {
                        if (t.size() != 3) {
                        ...
                        return AscCanonicalOD(context, left, right);
                    }));
    ...
    py::class_<DescCanonicalOD>(od_module, "DescCanonicalOD")
            ...
            [](py::tuple t) {
                ...
                int right = t[2].cast<int>();
                AttributeSet context = AttributeSet::FromVector(context_state);
                return DescCanonicalOD(context, left, right);
            }
        ));
    ...
    py::class_<SimpleCanonicalOD>(od_module, "SimpleCanonicalOD")
            ...
            .def(py::pickle(
                ...
                [](SimpleCanonicalOD const& od) {
                    ...
                    return py::make_tuple(context_state, right);
                },
                // __setstate__
                [](py::tuple t) {
                    if (t.size() != 2) {
                    ...
                    AttributeSet context = AttributeSet::FromVector(context_state);
                    return SimpleCanonicalOD(context, right);
                }));
    ...
    py::class_<ListOD>(od_module, "ListOD")
            ...
            .def(py::pickle(
                // __getstate__
                [](ListOD const& od) {
                    return py::make_tuple(od.lhs, od.rhs);
                },
                // __setstate__
                [](py::tuple t) {
                    if (t.size() != 2) {
