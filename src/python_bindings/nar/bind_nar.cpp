    ...
    py::class_<NAR>(nar_module, "NAR")
        ...
        .def(py::pickle(
                ...
                [](py::tuple t) {
                    ...
                    NAR nar;
                    std::unordered_map<size_t, std::shared_ptr<model::ValueRange>> ante_map = nar_serialization::DeserializeRangeMap(ante_dict);
                    std::unordered_map<size_t, std::shared_ptr<model::ValueRange>> cons_map = nar_serialization::DeserializeRangeMap(cons_dict);
