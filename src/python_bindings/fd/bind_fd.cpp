...
void BindFd(py::module_& main_module) {
    ...
    py::class_<FD>(fd_module, "FD")
            ...
            .def(py::pickle(
                    // __getstate__
                    [](FD const& fd) {
                        py::tuple schema_state = table_serialization::SerializeRelationalSchema(fd.GetSchema().get());
                    ...
                    [](py::tuple t) {
                        ...
                        Vertical lhs = table_serialization::DeserializeVertical(t[1].cast<py::tuple>(), schema.get());
                        Column rhs = table_serialization::DeserializeColumn(t[2].cast<py::tuple>(), schema.get());
