...
struct MetricVerifyingParams {
    ...
    MetricVerifyingParams(CSVConfig const& csv_config, char const* metric,
                          long double const min_parameter, std::vector<unsigned int> lhs_indices,
                          std::vector<unsigned int> rhs_indices, char const* algo = "brute",
...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(
                MetricVerifyingParams(kTestLong, "euclidean", 2, {0, 1}, {2}),
                MetricVerifyingParams(kTestLong, "euclidean", 1, {0}, {1}),
                MetricVerifyingParams(kTestLong, "euclidean", 4, {1}, {0}),
                MetricVerifyingParams(kTestLong, "euclidean", 5, {0}, {2}),
                MetricVerifyingParams(kTestLong, "euclidean", 0, {2}, {1}),
                MetricVerifyingParams(kTestMetric, "euclidean", 20500, {0}, {4}),
                MetricVerifyingParams(kTestMetric, "euclidean", 1059, {1}, {4}),
                MetricVerifyingParams(kTestMetric, "euclidean", 1, {1, 0}, {4}),
                MetricVerifyingParams(kTestMetric, "euclidean", 4.5724231, {0}, {2}),
                MetricVerifyingParams(kTestMetric, "euclidean", 7.53, {0}, {3}),
                MetricVerifyingParams(kTestMetric, "levenshtein", 2, {0}, {5}),
                MetricVerifyingParams(kTestMetric, "levenshtein", 3, {1}, {5}),
                MetricVerifyingParams(kTestMetric, "levenshtein", 4, {0}, {6}),
                MetricVerifyingParams(kTestMetric, "levenshtein", 10, {0}, {6}, "brute", true,
                                      false),
                MetricVerifyingParams(kTestMetric, "cosine", 0.661938299, {0}, {7}, "brute", false,
                                      true, 2),
                MetricVerifyingParams(kTestMetric, "cosine", 0.5, {1}, {7}, "brute", false, true,
                                      2),
                MetricVerifyingParams(kTestMetric, "cosine", 0.75, {1}, {6}, "brute", false, true,
                                      2),
                MetricVerifyingParams(kTestMetric, "cosine", 0.0298575, {1}, {5}, "brute", false,
                                      true, 1),
                MetricVerifyingParams(kTestMetric, "cosine", 0.661938299, {0}, {8}, "brute", false,
                                      true, 3),
                MetricVerifyingParams(kTestMetric, "cosine", 0.525658351, {1}, {8}, "brute", false,
                                      true, 3),
                MetricVerifyingParams(kTestLong, "euclidean", 5.0990195135928, {0}, {1, 2}),
                MetricVerifyingParams(kTestLong, "euclidean", 5.0990195135928, {0}, {1, 2},
                                      "calipers"),
                MetricVerifyingParams(kTestMetric, "euclidean", 3.081374600094, {0}, {9, 10}),
                MetricVerifyingParams(kTestMetric, "euclidean", 3.081374600094, {0}, {9, 10},
                                      "calipers"),
                MetricVerifyingParams(kTestMetric, "euclidean", 4.5, {0}, {11, 12}),
                MetricVerifyingParams(kTestMetric, "euclidean", 4.5, {0}, {12, 11}, "calipers"),
                MetricVerifyingParams(kTestMetric, "euclidean", 6.0091679956547, {0},
                                      {13, 14, 15})));
...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(
                ...
                HighlightTestParams(kTestMetric,
                                    ...
                                    "euclidean", {0}, {2}),
                HighlightTestParams(kTestMetric, {{3.9, 3.9, 2.07, 0, 0}}, "euclidean", {16}, {13}),
                HighlightTestParams(kTestMetric, {{inf, 3.9, 3.9, 2.07, 0}}, "euclidean", {16},
                                    {13}, "brute", true),
                HighlightTestParams(kTestMetric, {{2, 2, 2, 2, 2, 1}, {2, 2, 2, 2, 2, 2}},
                                    "levenshtein", {0}, {5}),
                HighlightTestParams(kTestMetric, {{4, 4, 4, 3, 3, 3}}, "levenshtein", {0}, {6}),
                HighlightTestParams(kTestMetric,
                                    {{0.661938, 0.661938, 0.661938, 0.6, 0.552786, 0.525658}},
                                    "cosine", {0}, {7}),
                HighlightTestParams(kTestMetric, {{0.5, 0.5, 0.410744}}, "cosine", {1}, {7}),
                HighlightTestParams(kTestMetric,
                                    {{0.661938, 0.661938, 0.53709, 0.525658, 0.428571, 0.316237},
                                     {inf, inf, inf, 0, 0, 0}},
                                    "cosine", {0}, {8}, "brute", true, 3),
                HighlightTestParams(kTestMetric, {{0.525658, 0.525658, 0.483602}}, "cosine", {1},
                                    {8}, "brute", true, 3),
                HighlightTestParams(kTestMetric, {{4.574986, 4.574986, 2.540827, 0, 0}},
                                    "euclidean", {16}, {13, 14, 15}),
                HighlightTestParams(kTestMetric, {{inf, 4.574986, 4.574986, 2.540827, 0}},
                                    "euclidean", {16}, {13, 14, 15}, "brute", true),
                HighlightTestParams(kTestMetric, {{4.543006, 4.54301, 2.41814, 0, 0}}, "euclidean",
                                    {16}, {13, 14}),
                HighlightTestParams(kTestMetric, {{inf, 4.543006, 4.54301, 2.41814, 0}},
                                    "euclidean", {16}, {13, 14}, "brute", true),
                HighlightTestParams(kTestMetric, {{4.543006, 4.54301, 2.41814, 0, 0}}, "euclidean",
                                    {16}, {13, 14}, "calipers"),
                HighlightTestParams(kTestMetric, {{inf, 4.543006, 4.54301, 2.41814, 0}},
                                    "euclidean", {16}, {13, 14}, "calipers", true),
                HighlightTestParams(kTestMetric,
                                    {{3.08137, 3.08137, 2.43892, 2.15623, 2.15421, 1.86557}},
                                    "euclidean", {0}, {9, 10}),
                HighlightTestParams(kTestMetric,
                                    {{3.08137, 3.08137, 2.43892, 2.15623, 2.15421, 1.86557}},
                                    "euclidean", {0}, {9, 10}, "calipers")));
