...
protected:
    ...
    static std::unique_ptr<algos::FDAlgorithm> CreateAlgoInstance(
                unsigned int max_lhs, bool EqNullsType, const std::filesystem::path& path, 
            ...
            algos::StdParamsMap params{
                    ...
                    {kTable, GetInputTable(path, separator, hasHeader)},
                    {kMaximumLhs, max_lhs},
                    {kEqualNulls, EqNullsType}
            };
