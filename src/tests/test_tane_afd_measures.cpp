...
TEST_P(TestTanePdepSelfValidation, SelfCalculationTest) {
    ...
    for (auto const& [column_id, expected_error] : p.errors) {
        ...
        config::ErrorType error = algos::Tane::PdepSelf(column_pli);
...
TEST_P(TestTaneAfdMeasuresValidation, ErrorCalculationTest) {
    ...
    for (auto const& [lhs_id, rhs_id, expected_error] : p.afds) {
        ...
        switch (p.error_measure) {
            case +algos::ErrorMeasure::pdep:
                error = algos::Tane::CalculatePdepMeasure(lhs, lhs->Intersect(rhs).get());
                break;
            case +algos::ErrorMeasure::tau:
                error = algos::Tane::CalculateTauMeasure(lhs, rhs, lhs->Intersect(rhs).get());
                break;
            case +algos::ErrorMeasure::mu_plus:
                error = algos::Tane::CalculateMuPlusMeasure(lhs, rhs, lhs->Intersect(rhs).get());
                break;
            case +algos::ErrorMeasure::rho:
                error = algos::Tane::CalculateRhoMeasure(lhs, lhs->Intersect(rhs).get());
                break;
            default:
                FAIL();
        }
...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(
                TaneValidationParams(+algos::ErrorMeasure::pdep,
                                     {{0, 1, 0.25},
                ...
                TaneValidationParams(+algos::ErrorMeasure::pdep,
                                     ...
                                     kIris),
                TaneValidationParams(+algos::ErrorMeasure::tau,
                                     {{0, 1, 0.0},
                ...
                TaneValidationParams(+algos::ErrorMeasure::tau,
                                     ...
                                     kIris),
                TaneValidationParams(+algos::ErrorMeasure::mu_plus,
                                     {{0, 1, 0.0},
                                      {0, 2, 0.0},
                                      {0, 3, 0.0},
                                      {0, 4, 0.0},
                ...
                TaneValidationParams(+algos::ErrorMeasure::mu_plus,
                                     ...
                                     kIris),
                TaneValidationParams(+algos::ErrorMeasure::rho,
                                     {{0, 1, 0.25},
                                      {0, 2, 0.125},
                                      {0, 3, 0.25},
                                      {0, 4, 0.2},
...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(
                TaneMiningParams(3325, 0.3, +algos::ErrorMeasure::pdep, kTestFD),
                TaneMiningParams(19266, 0.174, +algos::ErrorMeasure::pdep, kIris),
                TaneMiningParams(18528, 0.1, +algos::ErrorMeasure::pdep, kIris),
                TaneMiningParams(31178, 0.15, +algos::ErrorMeasure::pdep, kNeighbors10k),
                TaneMiningParams(1182, 0.21, +algos::ErrorMeasure::pdep, kNeighbors10k),
                TaneMiningParams(33180, 0.01, +algos::ErrorMeasure::tau, kTestFD),
                TaneMiningParams(11680, 0.1, +algos::ErrorMeasure::tau, kIris),
                TaneMiningParams(60896, 0.01, +algos::ErrorMeasure::tau, kIris),
                TaneMiningParams(52638, 0.1, +algos::ErrorMeasure::tau, kNeighbors10k),
                TaneMiningParams(44991, 0.01, +algos::ErrorMeasure::tau, kNeighbors10k),
                TaneMiningParams(33180, 0.01, +algos::ErrorMeasure::mu_plus, kTestFD),
                TaneMiningParams(60841, 0.1, +algos::ErrorMeasure::mu_plus, kIris),
                TaneMiningParams(60896, 0.01, +algos::ErrorMeasure::mu_plus, kIris),
                TaneMiningParams(12185, 0.1, +algos::ErrorMeasure::mu_plus, kNeighbors10k),
                TaneMiningParams(12185, 0.01, +algos::ErrorMeasure::mu_plus, kNeighbors10k),
                TaneMiningParams(33180, 0.01, +algos::ErrorMeasure::rho, kTestFD),
                TaneMiningParams(11873, 0.1, +algos::ErrorMeasure::rho, kIris),
                TaneMiningParams(47878, 0.01, +algos::ErrorMeasure::rho, kIris),
                TaneMiningParams(52638, 0.1, +algos::ErrorMeasure::rho, kNeighbors10k),
                TaneMiningParams(52638, 0.01, +algos::ErrorMeasure::rho, kNeighbors10k)));
