...
INSTANTIATE_TEST_SUITE_P(
    ...
    MeasureTestParams{kBaseDc, kTestDC1, MeasureType::kG1, 1.0},
    MeasureTestParams{kBaseDc, kTestDC4, MeasureType::kG1, 0.958677685950413},
    MeasureTestParams{kBaseDc, kTestDC5, MeasureType::kG1, 0.923469387755102},
    MeasureTestParams{kBaseDc, kTestDC1, MeasureType::kG1Norm, 1.0},
    MeasureTestParams{kBaseDc, kTestDC4, MeasureType::kG1Norm, 0.9545454545454545},
    MeasureTestParams{kBaseDc, kTestDC5, MeasureType::kG1Norm, 0.9175824175824175},
    MeasureTestParams{kBaseDc, kTestDC1, MeasureType::kG2, 1.0},
    MeasureTestParams{kBaseDc, kTestDC4, MeasureType::kG2, 0.942148760330578},
    MeasureTestParams{kBaseDc, kTestDC5, MeasureType::kG2, 0.9285714285714285}
    )
);
// clang-format on
