...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(TaneMiningParams(3325, 0.3, model::AfdMeasure::kPdep, kTestFD),
                          TaneMiningParams(19266, 0.174, model::AfdMeasure::kPdep, kIris),
                          TaneMiningParams(18528, 0.1, model::AfdMeasure::kPdep, kIris),
                          TaneMiningParams(31178, 0.15, model::AfdMeasure::kPdep, kNeighbors10k),
                          TaneMiningParams(1182, 0.21, model::AfdMeasure::kPdep, kNeighbors10k),
                          TaneMiningParams(33180, 0.01, model::AfdMeasure::kTau, kTestFD),
                          TaneMiningParams(11680, 0.1, model::AfdMeasure::kTau, kIris),
                          TaneMiningParams(60896, 0.01, model::AfdMeasure::kTau, kIris),
                          TaneMiningParams(52638, 0.1, model::AfdMeasure::kTau, kNeighbors10k),
                          TaneMiningParams(44991, 0.01, model::AfdMeasure::kTau, kNeighbors10k),
                          TaneMiningParams(33180, 0.01, model::AfdMeasure::kMuPlus, kTestFD),
                          TaneMiningParams(60841, 0.1, model::AfdMeasure::kMuPlus, kIris),
                          TaneMiningParams(60896, 0.01, model::AfdMeasure::kMuPlus, kIris),
                          TaneMiningParams(12185, 0.1, model::AfdMeasure::kMuPlus, kNeighbors10k),
                          TaneMiningParams(12185, 0.01, model::AfdMeasure::kMuPlus, kNeighbors10k),
                          TaneMiningParams(33180, 0.01, model::AfdMeasure::kRho, kTestFD),
