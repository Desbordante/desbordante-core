...
struct TaneMiningParams {
    ...
    TaneMiningParams(unsigned int result_hash, config::ErrorType error, model::AfdMeasure measure,
...
struct TaneValidationParams {
    model::AfdMeasure error_measure;
    std::vector<AFD> afds;
...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(
                TaneValidationParams(model::AfdMeasure::kPdep,
                                     {{0, 1, 0.25},
                ...
                TaneValidationParams(model::AfdMeasure::kPdep,
                                     ...
                                     kIris),
                TaneValidationParams(model::AfdMeasure::kTau,
                                     {{0, 1, 0.0},
                ...
                TaneValidationParams(model::AfdMeasure::kTau,
                                     ...
                                     kIris),
                TaneValidationParams(model::AfdMeasure::kMuPlus,
                                     {{0, 1, 0.0},
                                      {0, 2, 0.0},
                                      {0, 3, 0.0},
                                      {0, 4, 0.0},
                ...
                TaneValidationParams(model::AfdMeasure::kMuPlus,
                                     ...
                                     kIris),
                TaneValidationParams(model::AfdMeasure::kRho,
                                     {{0, 1, 0.25},
                                      {0, 2, 0.125},
                                      {0, 3, 0.25},
                                      {0, 4, 0.2},
...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(TaneMiningParams(29253, 0.3, model::AfdMeasure::kPdep, kTestFD),
                          TaneMiningParams(19266, 0.174, model::AfdMeasure::kPdep, kIris),
                          TaneMiningParams(18528, 0.1, model::AfdMeasure::kPdep, kIris),
                          TaneMiningParams(53657, 0.15, model::AfdMeasure::kPdep, kNeighbors10k),
                          TaneMiningParams(44088, 0.21, model::AfdMeasure::kPdep, kNeighbors10k),
                          TaneMiningParams(21731, 0.01, model::AfdMeasure::kTau, kTestFD),
                          TaneMiningParams(11680, 0.1, model::AfdMeasure::kTau, kIris),
                          TaneMiningParams(60896, 0.01, model::AfdMeasure::kTau, kIris),
                          TaneMiningParams(41837, 0.1, model::AfdMeasure::kTau, kNeighbors10k),
                          TaneMiningParams(57486, 0.01, model::AfdMeasure::kTau, kNeighbors10k),
                          TaneMiningParams(21731, 0.01, model::AfdMeasure::kMuPlus, kTestFD),
                          TaneMiningParams(60841, 0.1, model::AfdMeasure::kMuPlus, kIris),
                          TaneMiningParams(60896, 0.01, model::AfdMeasure::kMuPlus, kIris),
                          TaneMiningParams(43368, 0.1, model::AfdMeasure::kMuPlus, kNeighbors10k),
                          TaneMiningParams(43368, 0.01, model::AfdMeasure::kMuPlus, kNeighbors10k),
                          TaneMiningParams(21731, 0.01, model::AfdMeasure::kRho, kTestFD),
                          TaneMiningParams(11873, 0.1, model::AfdMeasure::kRho, kIris),
                          TaneMiningParams(47878, 0.01, model::AfdMeasure::kRho, kIris),
                          TaneMiningParams(41837, 0.1, model::AfdMeasure::kRho, kNeighbors10k),
                          TaneMiningParams(41837, 0.01, model::AfdMeasure::kRho, kNeighbors10k),
