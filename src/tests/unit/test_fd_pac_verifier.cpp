...
struct FDPACVerifyingParams {
    ...
    FDPACVerifyingParams(CSVConfig const& csv_config, config::IndicesType&& lhs_indices,
                         ...
                         std::vector<std::shared_ptr<config::ICustomMetric>>&& lhs_metrics = {},
                         std::vector<std::shared_ptr<config::ICustomMetric>>&& rhs_metrics = {},
...
auto const kStaticStringMetric =
        std::make_shared<config::StaticCustomMetric<std::string>>(kAlphabetMetric);
auto const kDynamicStringMetric = std::make_shared<config::DynamicCustomMetric>(
...
INSTANTIATE_TEST_SUITE_P(
        ...
        testing::Values(
                ...
                FDPACVerifyingParams(kMarineUrchins, {0}, {2}, 1, 0.673, {10}, 0.6, -1, -1, 0,
                                     false, {}, {kStaticStringMetric}),
                //   b. [default, custom] -> [default]
                FDPACVerifyingParams(kMarineUrchins, {0, 2}, {1}, 10, 0.961, {10, 1}, 0.9, -1, -1,
                                     350, false, {nullptr, kDynamicStringMetric}, {})));
...
INSTANTIATE_TEST_SUITE_P(
        ...
        testing::Values(
                ...
                FDPACVerifyingParams(kMushroom, {0}, {3}, 9, 0.676, {0}, 0.5, -1, -1, 0, false,
