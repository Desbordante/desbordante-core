...
protected:
    static algos::StdParamsMap GetParamMap(CSVConfig const& csv_config, double minsup,
        ...
        return {{kCsvConfig, csv_config},          {kInputFormat, algos::InputFormat::kSingular},
    ...
    static algos::StdParamsMap GetParamMap(CSVConfig const& csv_config, double minsup,
        ...
        return {{kCsvConfig, csv_config},
                {kInputFormat, algos::InputFormat::kTabular},
...
TEST_F(ARAlgorithmTest, SyntheticDatasetWithPruning) {
