...
CSVConfig const kAdult5attr = CreateCsvConfig("adult5attr.csv", ';', false);
...
CSVConfig const kCIPublicHighway20attr60k =
        CreateCsvConfig("CIPublicHighway20attr60k.csv", ',', true);
...
CSVConfig const kMushroomPlus3attr1k = CreateCsvConfig("mushroom+3attr1k.csv", ',', true);
CSVConfig const kMushroomPlus4attr1k = CreateCsvConfig("mushroom+4attr1k.csv", ',', true);
