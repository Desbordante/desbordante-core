#include "core/algorithms/dc/fast_adc/util/predicate_builder.h"

#include <array>
#include <assert.h>
#include <bitset>

#include "core/algorithms/dc/fast_adc/misc/typed_column_data_value_differences.h"
#include "core/algorithms/dc/fast_adc/model/column_operand.h"
#include "core/algorithms/dc/fast_adc/model/operator.h"
#include "core/algorithms/dc/fast_adc/model/predicate.h"
#include "core/algorithms/dc/fast_adc/providers/index_provider.h"
#include "core/algorithms/dc/fast_adc/providers/predicate_provider.h"
...
void PredicateBuilder::ProcessColumnPair(size_t i, size_t j,
    ...
    if (joinable || comparable) {
        ColumnOperand t_col_op(input[i].GetColumn(), ColumnOperandTuple::kT);
        ColumnOperand s_col_op(input[j].GetColumn(), ColumnOperandTuple::kS);
