...
private:
    ...
    void ValidateTypes(std::vector<::model::Type const*> const&) override;

    void AfterSetTypes() override {
        ConvertValues();
    }
...
protected:
    ...
    double ComponentDistance(std::size_t component_idx, std::byte const* x,
