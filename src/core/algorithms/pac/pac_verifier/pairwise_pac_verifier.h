...
protected:
    ...
    std::vector<EpsilonDelta> CalculateEmpiricalProbabilities(Pairs const& sorted_pairs) const;
    EpsilonDelta GetEpsilonDeltaForEpsilonImpl(double epsilon, Pairs const& pairs) const;
};
}  // namespace algos::pac_verifier
