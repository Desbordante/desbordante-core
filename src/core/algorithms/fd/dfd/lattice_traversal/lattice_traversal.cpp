...
#include <random>         // for unifor...
#include <stddef.h>       // for size_t
#include <unordered_map>  // for unorde...
#include <utility>        // for pair
#include <variant>        // for get

#include <boost/dynamic_bitset/dynamic_bitset.hpp>  // for dynami...

#include "fd/dfd/column_order/column_order.h"                  // for Column...
#include "fd/dfd/lattice_observations/lattice_observations.h"  // for Lattic...
#include "fd/dfd/node_category.h"                              // for NodeCa...
#include "fd/dfd/partition_storage/partition_storage.h"        // for Partit...
#include "fd/dfd/pruning_maps/dependencies_map.h"              // for Depend...
#include "fd/dfd/pruning_maps/non_dependencies_map.h"          // for NonDep...
#include "model/table/position_list_index.h"                   // for Positi...
#include "table/column.h"                                      // for Column
#include "table/column_layout_relation_data.h"                 // for Column...
