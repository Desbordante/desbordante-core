...
///
/// algorithm for mining GFD dependencies
///
...
protected:
    ...
    graph_t graph_;
    /* maximum number of vertices in the pattern of the mined dependency */
    std::size_t k_;
    /* minimum frequency of the mined dependency */
    std::size_t sigma_;
    ...
    void HorizontalSpawn(
            ...
            std::vector<std::vector<std::pair<std::vector<Literal>, std::vector<Literal>>>>&
                    forbidden_rules_set,
            std::map<std::string, std::map<std::string, std::set<std::string>>> const& attrs_info);
    ...
    void Initialize(
            ...
            std::vector<std::vector<std::pair<std::vector<Literal>, std::vector<Literal>>>>&
                    forbidden_rules_set,
            std::map<std::string, std::map<std::string, std::set<std::string>>>& attrs_info);
