...
protected:
    ...
    void GSpanDFS(gspan::DFSCode code, std::unordered_set<int> graph_ids);

    std::unordered_map<gspan::ExtendedEdge, std::unordered_set<int>, gspan::ExtendedEdge::Hash>
    RightMostPathExtensions(gspan::DFSCode code, std::unordered_set<int> graph_ids);

    std::unordered_set<gspan::ExtendedEdge, gspan::ExtendedEdge::Hash>
    RightMostPathExtensionsFromSingle(gspan::DFSCode code, gspan::graph_t const& graph);

    bool IsCanonical(gspan::DFSCode code);
