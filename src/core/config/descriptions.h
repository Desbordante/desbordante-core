...
constexpr auto kDMaxPValue = "maximum Fisher's P value for mined rules";
constexpr auto kDMaxRules = "algorithm will return this many rules or less (best ones first)";
